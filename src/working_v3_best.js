...
export default function App() {
  ...
  useEffect(() => {
    if (gesture !== "none") {
      speakGesture(gesture); // Speak whenever the displayed gesture updates
    }
  }, [gesture]);
  ...
  return (
    <div style={{ fontFamily: "Arial, sans-serif", padding: "20px", backgroundColor: "black", color: "white" }}>
      <h1 style={{ textAlign: "center", color: "#FFD700" }}>Real-Time Gesture Detector</h1>
